...
const MarkCollectionPage = () => {
    ...
    const [markCards, setMarkCards] = useState([
        { id: '_01', name: 'Mark I', url: './src/assets/mark-i.jpeg' },
        { id: '_02', name: 'Mark V', url: './src/assets/mark-v.jpeg' },
        { id: '_03', name: 'War Machine', url: './src/assets/mark-warmachine.jpeg' },
        { id: '_04', name: 'Mark L', url: './src/assets/mark-l.jpeg' },
        { id: '_05', name: 'Mark XLVI', url: './src/assets/mark-xlvi.jpeg' },
        { id: '_06', name: 'Hulk Buster', url: './src/assets/mark-hulkbuster.jpeg' },
        { id: '_07', name: 'Mark LXXXV', url: './src/assets/mark-lxxxv.jpeg' },
    ]);
    ...
    return (
        <>
            <section id="MarkCollectionIntro" className="relative h-[24rem] xs:h-[30rem] lg:h-[38rem] xl:h-[45rem] w-full p-4 overflow-hidden bg-no-repeat bg-cover bg-center" style={{ backgroundImage: 'url(./src/assets/media_02.jpeg)' }}>
                ...
                <div id="markBox" className="absolute top-0 left-0 z-[6] w-full h-full">
                    ...
                    <div className="w-full h-full flex justify-center items-center absolute top-0 left-0">
                        <img id="markElementIMG" className="markinitial w-[60%] md:w-[50%] drop-shadow-[0_0_1rem_rgba(0,0,0,0.4)] z-[2]" src="./src/assets/mark-collection-masked.svg" alt="Iron Man Mark Collection Element" />
                    </div>
            ...
            <section id="MarkCollections" className="relative h-[24rem] xs:h-[30rem] lg:h-[38rem] xl:h-[45rem] w-full p-4 overflow-hidden bg-no-repeat bg-cover bg-center" style={{ backgroundImage: 'url(./src/assets/media_02.jpeg)' }}>
                <div className="CollectionBackground w-full h-full absolute top-0 left-0 overflow-hidden">
                    {/* Overlay Gradient */}
                    <div className="w-full h-full absolute top-0 left-0 overflow-hidden bg-gradient-to-b from-[rgba(0,0,0,0.8)] via-transparent to-[rgba(0,0,0,0.8)] z-[2]">
                    </div>
